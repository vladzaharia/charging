        ...
        <div className={`container mx-auto p-4 ${error ? 'text-red-400' : 'text-white'}`}>
          ...
          {status && (
            <div className="flex flex-col md:flex-row gap-6 items-center justify-between">
              {status.code && (
                <div className="font-mono p-3 pr-4 border-2 rounded-xl border-charge-blue flex-row gap-4 items-center justify-center md:flex hidden">
                  ...
                  <div className="flex flex-col items-center">
                    <span>
                      {[...status.code].slice(0, 4).map((char, i) => (
                        <span
                          key={i}
                          className={/[0-9]/.test(char) ? 'text-charge-green' : 'text-charge-blue'}
                        >
                          {char}
                        </span>
                      ))}
              ...
              <div className="flex flex-col gap-2 items-center justify-center min-w-72">
